...
def in_progress_tasks(department_id):
    """Show all in progress tasks for a specific department"""
...
def completed_tasks(department_id):
    """Show all completed tasks for a specific department"""
    department = Department.query.get_or_404(department_id)
...
def add_task(department_id):
    """Add a new task for a specific department"""
    department = Department.query.get_or_404(department_id)
    form = TaskForm()
...
def add_task_result(task_id):
    """Add a result for a specific task"""
